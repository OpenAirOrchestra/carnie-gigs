	...
	function __construct() {
		...
		$this->metadata_fields = array(
			...
			array('name' => 'Food/Water provided',
				'category' => 'gig_accessibility',
				'desc' => 'Is there food/water provided?',
			...
			array('name' => 'Parade',
				'category' => 'gig_accessibility',
				'desc' => 'Does this gig include a parade? If so, describe estimated length or duration in gig details.',
				'id' => $this->metadata_prefix . 'parade',
				'type' => 'checkbox',
			),
			array('name' => 'Paved flat pathways',
				'category' => 'gig_accessibility',
				'desc' => 'Do outdoor pathways have accessibility friendly surfaces? If not, describe describe in gig details, ex. gravel, sand, wood chips, slopes, uneven terrain.',
